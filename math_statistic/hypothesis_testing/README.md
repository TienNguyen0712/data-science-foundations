...
|----------|---------|---------|-----------|
| Kiểm định tham số |  z-test |	So sánh 1 trung bình | Trung bình lệch bao nhiêu σ? | 
| | t-test 1 mẫu |  
| | t-test 2 mẫu | So sánh 2 nhóm độc lập | 
| | t-test cặp | So sánh trước sau | Mức thay đổi có khác 0? |
...
| | Wilcoxon signed-rank	|  So sánh trước sau | Thay đổi có xu hướng tăng/giảm? | 
| | F-test | So sánh phương sai | Hai độ phân tán có khác? |
| | Kruskal–Wallis | Từ 3 nhóm trở lên | Nhóm nào có hạng cao hơn | 
